...
public abstract class JsonFileBase
{
    ...
    /// </remarks>
    protected JsonFileBase(string filePath, JsonSerializerOptions jsonOptions)
    {
        _filePath = filePath;
    ...
    /// Initializes an instance of <see cref="JsonFileBase" />.
    /// </summary>
    protected JsonFileBase(string filePath, IJsonTypeInfoResolver jsonTypeInfoResolver)
        : this(
            filePath,
    ...
    protected JsonFileBase(string filePath)
